...
health status will be sent to the monitoring script. If the
...
Soon after startup the server will write a list of the server's health
checks to the "healthchecks.json" file in the log directory.
